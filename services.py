...
def create_post(title : str, content : str, userid : int):
    if data_access_mysql.create_post(title , content , userid):
...
def create_comment(content : str, post_id : int, user_id : int):
    if data_access_mysql.create_comment(content, post_id, user_id):
